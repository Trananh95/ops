...
## Triển khai CICD trên gitlab
Các bước triển khai cicd trên gitlab:
* Tạo Gitlab Repository
* Setup Gitlab registry
* Setup Gitlab runner(nếu có)
* Setup Gitlab-CI 
* Handbook: https://handbook.gitlab.com/handbook/customer-success/professional-services-engineering/education-services/gitlabcicdhandson/
